...
proc update_PARAM_VALUE.FIFO_Counter_WIDTH { PARAM_VALUE.FIFO_Counter_WIDTH } {
	# Procedure called to update FIFO_Counter_WIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.FIFO_Counter_WIDTH { PARAM_VALUE.FIFO_Counter_WIDTH } {
	# Procedure called to validate FIFO_Counter_WIDTH
	return true
}
...
proc update_MODELPARAM_VALUE.FIFO_Counter_WIDTH { MODELPARAM_VALUE.FIFO_Counter_WIDTH PARAM_VALUE.FIFO_Counter_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.FIFO_Counter_WIDTH}] ${MODELPARAM_VALUE.FIFO_Counter_WIDTH}
}
